...
/* ── Member avatar (added for ranking tab) ───────────────────── */
function MemberAvatar({ initials, color, size = 44 }) {
  return (
    <div style={{
      ...
      <span style={{ fontSize: Math.round(size * 0.3), fontWeight: 700, color: '#fff', letterSpacing: -0.5 }}>
        {initials}
      </span>
    </div>
  )
        ...
        {tab === 'ranking' && (
          <>
            ...
            <div className="card" style={{
              ...
              padding: '20px 12px 0', marginBottom: 4,
            }}>
                ...
                {[1, 0, 2].map((idx, col) => {
                  ...
                  return (
                    <div key={r.rank} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
                      ...
                      <MemberAvatar initials={r.initials || r.nameKr.charAt(0)} color={r.color || '#666'} size={isFirst ? 52 : 42} />
                      ...
                      <div style={{
                        width: '100%', height: blockH, background: blockColor,
            ...
            <div className="card cd-list">
              {rest.map((r) => (
                <div className="cd-mem" key={r.rank}>
                  <span style={{ width: 24, fontWeight: 700, fontSize: 15, color: 'var(--text-3)', textAlign: 'center', flexShrink: 0 }} className="num">
                    {r.rank}
                  </span>
